...
func init() {
	...
	fmt.Println("Number of elements in the list:", ctr)
	fmt.Println("Number of elements in the matrix:", rows*cols)
}
...
// ColumnTraverse traverses the matrix column by column.
...
// RowTraverse traverses the matrix row by row.
